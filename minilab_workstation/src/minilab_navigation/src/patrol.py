...
class NavTest():
    def __init__(self):
        ...
        locations['hall_foyer'] = Pose(Point(4.535, -0.426, 0.036), Quaternion(0.000, 0.000, 0.223, 0.975))
        locations['hall_kitchen'] = Pose(Point(10.035, -0.452, 3.127), Quaternion(0.000, 0.000, -0.670, 0.743))
